  ...
  <div id="app">
    ...
    <div class="wrap flex__wrap f__start input__area">
      ...
      @endauth
        ...
        <div id="app">
            <survey-register-component survey_id="{{ $survey_id }}" enable_sms="{{ $enable_sms }}" mode="edit" is-charge="{{ $isCharge }}" is-viewer="{{ $isViewer }}" url-prefix="{{ $urlPrefix }}"></survey-register-component>
        </div>
        @else
